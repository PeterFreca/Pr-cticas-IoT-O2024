...
#define SECRET_CH_ID 2720912 // ID de canal de ThingSpeak
#define SECRET_WRITE_APIKEY "7JAGMU45PROZWFOT" // API Key de ThingSpeak

// URL completa de la API de OpenWeatherMap
#define OPENWEATHER_REQUEST_PATH "https://api.openweathermap.org/data/2.5/weather?lat=20.606900&lon=-103.415629&appid=b37ef60fd4f3279235049ede38eb92fc&units=metric"
