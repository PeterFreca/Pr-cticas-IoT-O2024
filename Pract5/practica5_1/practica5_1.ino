...
#define TOKEN "BBUS-OIGvZpqrr6Gg7eXxdUmmvYrDBA35el" // Ubidots TOKEN name el mismo que usamos en clase 
#define MQTT_CLIENT_NAME "aBcD1234" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices 
...
void loop() { 
  ...
  sprintf(payload, "%s } }", payload); // cierra el mensaje 
  Serial.println("  Enviando Humedad al vsirtual device en ubidots via MQTT....");  
  client.publish(topic, payload); 
